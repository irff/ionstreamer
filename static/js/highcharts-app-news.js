$(function(){
        ...
        series: {
          ...
          events: {
            click: function (event) {
              ...
              angular.element('#analyzenewsController').scope().fetchTweetsAt($('#keyword').text(), kelas, t1.toISOString(), t2.toISOString());
              angular.element('#analyzenewsController').scope().$applyAsync();
        ...
        series: {
          ...
          events: {
            click: function (event) {
              ...
              angular.element('#analyzenewsController').scope().fetchTweetsTo(keyword, username);
              angular.element('#analyzenewsController').scope().$applyAsync();
              $('#tweets').foundation('reveal', 'open');
            }
          }
        ...
        series: {
          ...
          events: {
            click: function (event) {
              var keyword = $("#keyword").text();
              var username = event.point.name;
              angular.element('#analyzenewsController').scope().fetchTweetsFrom(keyword, username);
              angular.element('#analyzenewsController').scope().$applyAsync();
              $('#tweets').foundation('reveal', 'open');
            }
          }
        ...
        series: {
          ...
          events: {
            click: function (event) {
              ...
              angular.element('#analyzenewsController').scope().fetchTweetsHashtag(keyword, hashtag);
              angular.element('#analyzenewsController').scope().$applyAsync();
              $('#tweets').foundation('reveal', 'open');
            }
          }
  ...
  drawFreq = function() {
    $("#freq").html(spin);
    $.ajax({
      url: '/api/analyzenews/freq/'+encodeURIComponent($('#keyword').text()),
  ...
  drawTopMention = function() {
    ...
    $.ajax({
      url: '/api/analyzenews/topmention/'+encodeURIComponent($('#keyword').text()),
  ...
  drawTopPosting = function() {
    ...
    $.ajax({
      url: '/api/analyzenews/topposting/'+encodeURIComponent($('#keyword').text()),
  ...
  drawTopHashtag = function() {
    ...
    $.ajax({
      url: '/api/analyzenews/tophashtag/'+encodeURIComponent($('#keyword').text()),
  ...
  drawTopURL = function() {
    $("#topurl").html(spin);
    $.ajax({
      url: '/api/analyzenews/topurl/'+encodeURIComponent($('#keyword').text()),
